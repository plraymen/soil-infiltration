...
import './button.css'
import androidApp from "./SoilInfiltrometer.apk"
...
function Downloads({that}) {
    ...
    return (
        <div>
            ...
            <div>
                <h3><li>Download Android Application: <a href={androidApp}>Click Here</a> </li></h3>
                <h3><li>To download (click the link above) and install, you will need to enable install secondary Apps.</li></h3>
            </div>
